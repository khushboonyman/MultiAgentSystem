...
os.chdir(basepath + "/levels/levels2020/works")
...
for test in tests:
    total += 1
    stream = os.popen('java -jar ../server.jar -l levels/levels2020/works/' + test + ' -c "python planningClient.py --server=True" -t 300')
